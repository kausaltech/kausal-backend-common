# Generated by Django 5.1.4 on 2025-02-27 15:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(blank=True, choices=[('review', 'Review comment'), ('sticky', 'Sticky comment')], max_length=20, null=True)),
                ('state', models.CharField(blank=True, choices=[('resolved', 'Resolved'), ('unresolved', 'Unresolved')], max_length=20, null=True)),
