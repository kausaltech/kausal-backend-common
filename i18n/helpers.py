...
def convert_language_code(
    language_code: str,
    output_format: Literal['kausal', 'django', 'modeltrans', 'next.js', 'wagtail Locale'],
) -> str:
    """
    ...
    Args:
        ...
        output_format (str): The output format to which to convert the language code to. The formats are:
            ...
            'wagtail Locale': The format used by Wagtail Locale objects. ('es-US')
    ...
    match output_format:
        case "kausal" | "next.js" | "wagtail Locale":
        ...
        case "modeltrans":
            ...
            return result
        case _:
            format_options = ["kausal", "django", "modeltrans", "next.js", "wagtail Locale"]
