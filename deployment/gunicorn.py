...
def _patch_prometheus_master() -> None:
    ...
    from gunicorn_prometheus_exporter.master import PrometheusMaster  # type: ignore[import-not-found, import-untyped]
...
def _get_prometheus_hooks() -> dict | None:
    try:
        from gunicorn_prometheus_exporter.hooks import (  # type: ignore[import-not-found, import-untyped]
            default_on_exit,
            default_on_starting,
            default_post_fork,
            default_when_ready,
