...
class BeforeAfterHookMixin(Generic[_Form], HookResponseMixin):
...
class PanelMixin(Generic[_Form]):
    panel: ClassVar[Panel | None]
    def get_panel(self) -> Panel | None: ...
    def get_bound_panel(self, form: _Form) -> Panel.BoundPanel | None: ...
    def get_form_class(self) -> type[_Form]: ...
    def get_context_data(self, **kwargs: Any) -> dict[str, Any]: ...
...
class CreateEditViewOptionalFeaturesMixin(Generic[_Model, _Form]):
    ...
    def get_success_message(self, instance: _Model | None = None) -> str: ...
...
class RevisionsRevertMixin(Generic[_Model]):
