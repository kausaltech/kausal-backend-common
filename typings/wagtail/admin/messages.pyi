...
def debug(request: HttpRequest, message: StrOrPromise, buttons: Sequence[Button] | None = None, extra_tags: str = '') -> None: ...
...
def error(request: HttpRequest, message: StrOrPromise, buttons: Sequence[Button] | None = None, extra_tags: str = '') -> None: ...
