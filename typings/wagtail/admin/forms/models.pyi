...
def formfield_for_dbfield(db_field: DBField, **kwargs: Any) -> FormField: ...  # noqa: ANN401
...
class WagtailAdminModelFormMetaclass(PermissionedFormMetaclass, ClusterFormMetaclass):
    options_class: type[ModelFormOptions] = WagtailAdminModelFormOptions  # noqa: PYI015
