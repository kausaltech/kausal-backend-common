...
def get_model_string(model: type[Model] | Model) -> str:
    """
...
def resolve_model_string(model_string: str | type[Model], default_app: str | None = None) -> type[Model]:
    """
...
def get_supported_content_language_variant(lang_code, strict=...):
    """
...
def safe_md5(data=..., usedforsecurity=...):
    """
...
def make_wagtail_template_fragment_key(fragment_name, page, site, vary_on=...):
    """
