...
class ObjectTypeRegistry:
    ...
    def register(self, cls, value=..., exact_class=...): # -> None:
        ...
    
    def get_by_type(self, cls): # -> None:
        ...
    
    def get(self, obj): # -> object | type | None:
        ...
...
class ModelFieldRegistry(ObjectTypeRegistry):
    ...
    def register(self, field_class, to=..., value=..., exact_class=...): # -> None:
        ...
    
    def foreign_key_lookup(self, field): # -> object | type | None:
        ...
