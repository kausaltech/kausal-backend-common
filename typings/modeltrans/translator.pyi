...
def get_i18n_field(Model: Model | type[Model]) -> TranslationField | None: ...  # noqa: N803
def get_translated_models(app_name) -> Generator[type[Model], Any, None]: ...
def get_i18n_field_param(model: type[Model], i18n_field: TranslationField, param_name: str) -> Any: ...  # noqa: ANN401
